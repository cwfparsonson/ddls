...
class RandomJobPlacer(Placer):
    ...
    def get_placement(self, 
        ...
        for job in jobs:
            ...
            for op in job.computation_graph.nodes:
                ...
                valid_placements = self._get_valid_placements(job, op, cluster, worker_to_available_memory)
    ...
    def _get_valid_placements(self, job, op, cluster, worker_to_available_memory):
